...
public class SocketThread extends Thread {
    ...
    public final static int FILE_TRANS_STATUS_FILENAME = 0x01;//文件传输状态
    ...
    public final static int PACKAGE_TYPE_FILENAME = 0x01; //文件内容
    ...
    public SocketThread(Socket aSocket) {
        ...
        //System.out.println(aSocket.getInetAddress().getAddress());
...
//是否是文件发送者
    ...
    public String getFileTransMessage(){
        if(fileSender){
            return "发送文件 目标IP: "+getIP()+" 端口:"+getPort();
        }
        else{
